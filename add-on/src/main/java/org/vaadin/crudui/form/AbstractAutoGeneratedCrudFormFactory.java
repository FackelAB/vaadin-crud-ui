...
public abstract class AbstractAutoGeneratedCrudFormFactory<T> extends AbstractCrudFormFactory<T> {
    ...
    protected SerializableFunction<T,T> readInstanceSupplier;
    protected SerializableFunction<T,T> updateInstanceSupplier;
    protected SerializableFunction<T,T> deleteInstanceSupplier;
    ...
    @Override
    public void setReadLazyPropertySupplier(SerializableFunction<T, T> readInstanceSupplier) {
        this.readInstanceSupplier = readInstanceSupplier;
    }
    @Override
    public void setUpdateLazyPropertySupplier(SerializableFunction<T, T> updateUpdateSupplier) {
        this.updateInstanceSupplier = updateUpdateSupplier;
    }

    @Override
    public void setDeleteLazyPropertySupplier(SerializableFunction<T, T> deleteInstanceSupplier) {
        this.deleteInstanceSupplier = deleteInstanceSupplier;
    }
    ...
    @Override
    public SerializableFunction<T, T> getReadInstanceSupplier() {
        if (readInstanceSupplier == null){
            readInstanceSupplier = domainObject -> domainObject;
        }
        return readInstanceSupplier;
    }
    @Override
    public SerializableFunction<T, T> getUpdateInstanceSupplier() {
        return updateInstanceSupplier != null ? updateInstanceSupplier : getReadInstanceSupplier();
    }

    @Override
    public SerializableFunction<T, T> getDeleteInstanceSupplier() {
        return deleteInstanceSupplier != null ? deleteInstanceSupplier : getReadInstanceSupplier();
    }
